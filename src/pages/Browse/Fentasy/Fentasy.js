...
const Fentasy = () => {
  ...
  const [getFentacyBooks, setFentacyBooks] = useState([]);

  useEffect(() => {
    GetFentacyBooksHandler();
  }, []);

  const GetFentacyBooksHandler = async () => {
    let result = await axios.get("http://103.171.181.46:2081/api/books");
    console.log(result.data.data);
    setFentacyBooks(result.data.data);
  };
    ...
    return (
      ...
      <div className="browse-card">
        <div className="container">
          <div className="row">
            {getFentacyBooks.slice(0,3).map((topWerewolfBooks) => (<div className="col-sm-12 col-md-6 col-lg-4">
      ...
      <div className="browse-book-content">
        <div className="container">
          {getFentacyBooks.map((wereWolfBooks, index) => (
            <div className="row">
